...
public struct Lark_Contact: Sendable {
  ...
  public var latestMsg: String = String()
...
public struct Lark_ContactList: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var contacts: [Lark_Contact] = []
...
extension Lark_Contact: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Lark_Contact, rhs: Lark_Contact) -> Bool {
...
extension Lark_ContactList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Lark_ContactList, rhs: Lark_ContactList) -> Bool {
